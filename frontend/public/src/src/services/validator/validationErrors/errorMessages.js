...
export function display_nameErrors(validation) {
  return generateErrors(validation, 'display_name', [
    { validator: 'required', message: 'RegisterForm.Errors.display_name.Required' },
    { validator: 'minLength', message: 'RegisterForm.Errors.display_name.MinLength' }
  ])
}
