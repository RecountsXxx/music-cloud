...
public class UserProfileLikedSongService implements UserProfileLikedInterface {
    ...
    public List<UserProfileLikedRepostedDTO> getUserProfilesThatLikedContent(UUID contentId) throws DataNotFoundException {
        ...
        return userProfileLikedSongRepository
                ...
                .map(userProfileLikedSongModel -> new UserProfileLikedRepostedDTO(
                        getShortUserProfileDTO(userProfileLikedSongModel.getUserProfile(), imageService),
                        userProfileLikedSongModel.getCreatedAt()
                ))
    ...
    public List<LikeContentDTO> getLikedContent(UUID userProfileId) throws DataNotFoundException {
        ...
        return userProfileLikedSongRepository
                ...
                .map(userProfileLikedSongModel -> {
                    ...
                    return new LikeContentDTO(shortSongDTO, ContentType.SONG, userProfileLikedSongModel.getCreatedAt());
                })
                .collect(Collectors.toList());
    }
